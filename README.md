...
3. Run workflow steps one at a time. After each click, the same workflow screen tells the user what output was produced and whether to review before continuing. The later review screens remain as detail workspaces, not the primary navigation path.
