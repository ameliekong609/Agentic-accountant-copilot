...
def main() -> int:
    ...
    chat_id = _env("ACCOUNTANT_COPILOT_TELEGRAM_CHAT_ID", "HERMES_SESSION_CHAT_ID", "TELEGRAM_CHAT_ID", "TELEGRAM_HOME_CHANNEL")
    thread_id = _env("ACCOUNTANT_COPILOT_TELEGRAM_THREAD_ID", "HERMES_SESSION_THREAD_ID", "TELEGRAM_THREAD_ID")
